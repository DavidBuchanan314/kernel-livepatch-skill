...
3. Decompile+disassemble functions of interest using `ghidra_print_func.py <function_name>`. Any addresses you see here are absolute, ASLR is already accounted for.
